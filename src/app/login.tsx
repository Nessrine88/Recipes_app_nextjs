...
<div className="space-y-5 w-5xl">
    <input type="email" name="Email" id="email" placeholder='Email or phone number' className="w-full bg-white py-4 pr-10 pl-3  text-left rounded-3xl  border-2 border-transparent focus:!border-green-400 focus:outline-none "/> <br />
     <input type="password" name="password" id="password" placeholder='password' className="w-full py-4 pr-10 pl-3 text-left rounded-3xl border-2 border-transparent focus:!border-green-400 focus:outline-none" />
</div>
